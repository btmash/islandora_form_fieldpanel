# Islandora XML Form Element: FieldPanel [![Build Status](https://api.travis-ci.org/btmash/islandora_form_fieldpanel.png?branch=7.x)](https://travis-ci.org/btmash/islandora_form_fieldpanel)
